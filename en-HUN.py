class Strings:
    ...
    #settings_log
    settings_log_1 = "`Altdentification engedélyezése '"
    settings_log_2 = "`Admin szerep`"
    settings_log_3 = "`Mod Role`"
    settings_log_4 = "`Emberi szerep`"
    settings_log_5 = "`Fakitermelés`"
    settings_log_6 = "`Általános csatorna`"
    settings_log_7 = "`Bot csatorna`"
    settings_log_8 = "`Nyelv`"
    settings_log_9 = "`előtagja`"
    settings_log_10 = "`Időzóna`"
    settings_log_11 = "`Minimális számlaszám`"
    settings_log_12 = "`Autorole`"
    settings_log_13 = "`Jelentkezési csatorna`"
    settings_log_one = "Beállítás"
    settings_log_two = "változott "
    settings_log_three = "Módosította: "
    settings_log_14 = "`Hitelesítési módszerek`"
    settings_log_15 = "`Naplózási beállítások`"
    settings_log_16 = "`Időtúllépés`"
